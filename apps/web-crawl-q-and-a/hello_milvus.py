...
start_time = time.time()
result = hello_milvus.query(expr="random > 0.5", output_fields=[
                            "random", "embeddings"])
end_time = time.time()
...
r2 = hello_milvus.query(expr="random > 0.5", offset=1,
                        limit=3, output_fields=["random"])
...
result = hello_milvus.search(vectors_to_search, "embeddings", search_params,
                             limit=3, expr="random > 0.5", output_fields=["random"])
end_time = time.time()
